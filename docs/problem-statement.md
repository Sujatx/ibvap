# Problem Statement (Official, Immutable)

**Problem Statement ID:** 26187

**Problem Statement Title:** AI-Based Intelligent Video Analytics Platform for
Border Surveillance using existing CCTV Infrastructure.

> This is the official SIH problem statement. It is the immutable source of
> truth for this project. Do not rewrite, simplify, reinterpret, remove, or add
> anything to it. Copied verbatim.
